...
export type FluentMessageId =
  ...
  | 'context-add-to-new-event-flat'
  | 'context-add-to-new-event-submenu'
  | 'event-editor-create-button'
  | 'event-editor-create-document-label'
  | 'event-editor-create-sources-label'
  | 'event-editor-create-sources-skipped'
  ...
  | 'event-editor-duplicate-button'
  | 'event-editor-duplicate-cancel'
  | 'event-editor-duplicate-confirm'
  ...
  | 'timeline-cross-library-switch-message'
  | 'timeline-cross-library-switch-message-unknown-current'
  | 'timeline-cross-library-switch-title'
  | 'timeline-data-trashed-open'
  | 'timeline-delete-confirm-message'
  | 'timeline-delete-confirm-title'
  | 'timeline-discard-edit-confirm-message'
  | 'timeline-discard-edit-confirm-title'
  | 'timeline-menu-open'
